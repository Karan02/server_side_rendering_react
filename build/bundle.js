...
exports.default = function (req, store, context) {
    ...
    // this will get all helmet tags in the application
...
exports.default = {
    loadData: loadData,
    component: (0, _reactRedux.connect)(mapState, { fetchUsers: _actions.fetchUsers })(UsersList)
};
...
exports.default = {
    component: (0, _reactRedux.connect)(mapState, { fetchAdmins: _actions.fetchAdmins })((0, _requireAuth2.default)(AdminListPage)),
    loadData: function loadData(_ref2) {
        var dispatch = _ref2.dispatch;
